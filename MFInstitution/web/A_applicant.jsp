...
<tr>
<td>
  <form action="A_insapp.jsp" method="get">
    <button class="button" type="Submit">Register Customer</button></form>
  </td>
  <td>
  <form action="A_delapp.jsp" method="get">
  <button class="button" type="Submit">Delete Customer</button></form>
</td>
<td>
  <form action="A_editapp.jsp" method="get">
  <button class="button" type="Submit">Edit Customer</button></form>
</td>
</tr>
<tr>
    <td></td>
