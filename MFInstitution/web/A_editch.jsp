        ...
        <%       
         try{
          ...
          try {
            ...
            String s1="update provider set PNAME='"+pname+"',AADHAR='"+aadhar+"',GENDER='"+gender+"',PHONE='"+pno+"',EMAIL='"+email+"',USERNAME='"+user+"',PASSWORD='"+pass+"' where PID='"+pid+"'";
            Statement stmt=cn.createStatement();
            stmt.executeQuery(s1);
            %> 
<br><br><br><br>
<h1 style="color:#1A5276; text-align:center;">Provider Details Edited! 
</h1> 
