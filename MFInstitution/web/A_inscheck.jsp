        ...
        <%       
         try{
          ...
          try {
            ...
            String s2="insert into C_FINANCIAL values('"+ano+"','"+annual+"','"+occ+"','"+qual+"','"+aadhar+"')";
            String s3="insert into CUSTOMER values('"+cid+"','"+ano+"')";
            ...
            %> 
<br><br><br><br>
<h1 style="color:#1A5276; text-align:center;">Customer Registered! 
</h1> 
